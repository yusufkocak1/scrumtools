<template>
  <div class="container flex flex-col">
    ...
    <div class="flex flex-col justify-center items-center font-extrabold text-4xl p-12 border-4 gap-4">
      <Button
          @click="newRound"
    ...
    <div class="p-2 flex justify-center lg:justify-start flex-wrap gap-2 ">
      <div v-for="vote in votes" :key="vote">
        <div class="border-4 border-slate-200 rounded-lg  p-4 flex  flex-col gap-2 justify-center items-center">
          <pokerCard :key="'vote'+vote" :number="isVotesVisible ? vote.vote:'?'" :selectable="false"></pokerCard>
