  ...
  <div class="relative flex flex-col   shadow-sm border border-slate-200 rounded-lg lg:w-96 bg-white p-1 mx-2">
    ...
    <div class="p-5 my-3">
      <div class="w-full max-w-sm min-w-[200px]">
        <div class="relative">
          <input type="text" v-model="teamName" class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md pl-3 pr-16 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" placeholder="Team Name" />
          <button
