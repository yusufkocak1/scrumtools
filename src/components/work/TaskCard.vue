<template>
  <div class="w-full">
    ...
    <div v-if="task.labels && task.labels.length" class="flex flex-wrap gap-1 mb-3">
      ...
      <span v-if="task.labels.length > 2" class="text-xs text-gray-400">
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-2">
        <div v-if="task.assignee" class="flex items-center space-x-1">
          ...
          <span class="text-xs text-gray-600 truncate max-w-20">{{ task.assignee }}</span>
        </div>
      ...
      <div class="flex items-center space-x-2">
        <div v-if="task.storyPoints" class="flex items-center space-x-1">
          ...
          <span class="text-xs text-gray-500">{{ task.storyPoints }}</span>
        </div>
        ...
        <div v-if="task.attachments && task.attachments.length" class="flex items-center space-x-1">
          ...
          <span class="text-xs text-gray-500">{{ task.attachments.length }}</span>
        </div>
