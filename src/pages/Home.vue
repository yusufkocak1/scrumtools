      ...
      <div v-if="selectedTeam" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div @click="gotoRetrospective"
          ...
          <div class="p-8">
            ...
            <p class="text-gray-600 mb-4">Organize sprint retrospectives and track team development</p>
