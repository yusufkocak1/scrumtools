              ...
              <tr v-for="(member, email) in selectedTeam.members" :key="member">
                ...
                <td class="p-4 border-b border-blue-gray-50">
                  <div class="ml-auto grid place-items-center justify-self-end">
                    <button v-if="isAdmin"  @click="removeMember(email)" class="rounded-md border border-transparent px-2 text-center text-sm transition-all text-slate-600 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button">
